...
<template>
  <button v-if="!isLoaded" :class="buttonStyle">
    Loading buffer...
  </button>
  <button v-if="isLoaded && !isPlaying" :class="buttonStyle" @click="start">
    Play
  </button>
  <button v-if="isLoaded && isPlaying" :class="buttonStyle" @click="stop">
    Stop
  </button><br>
  music by
  <a href="https://www.youtube.com/watch?v=whKBW_hu4nE">Wouter Vernaillen</a><br>

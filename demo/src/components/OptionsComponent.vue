<template>
  <div class="green mt-2">Load a preset:</div>
  <div class="pl-5">
    <PresetSelector />
  </div>
  <div class="green mt-5">Options:</div>
  <div class="pl-5">
    <ModeSelector />
    <div>
    ...
    <div>
      <div class="green mt-5 mb-2">Mode 10 / outlineBars:</div>
      <div class="pl-5">
    ...
    <div>
      <div class="green mt-5 mb-2">Radial effect:</div>
      <div class="pl-5">
        <button v-btnClass="options.radial" @click="toggle">radial</button>
